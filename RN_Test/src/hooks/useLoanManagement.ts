...
export const useLoanManagement = () => {
  ...
  const submitLoanApplication = async (userId?: string) => {
    try {
      ...
      console.log("Submit loan application - effectiveUser:", effectiveUser);
      console.log("Submit loan application - user from state:", user);
      console.log("Submit loan application - userId param:", userId);
