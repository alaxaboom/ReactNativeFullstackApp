...
import { useLoginUserMutation, useRegisterUserMutation, useGetMeQuery, useRefreshTokenMutation } from '../../entities/user';
import { setCredentials, setUser, logout, setLoading } from '../../entities/user';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { RootState, resetApiCache } from '../api/store';
...
export const useAuth = () => {
  ...
  const { isLoading: authIsLoading, isAuthenticated } = useAppSelector((state: RootState) => state.auth);
